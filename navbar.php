    ...
    <div class="flex flex-wrap items-center justify-between mx-auto p-4 md:px-20">
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-default">
        <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:items-center">
          ...
          <li>
            <a href="#" class="block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">Tentang</a>
          </li>
          <li>
          ...
          <li>
            <a href="#" class="block py-4 px-8 text-white bg-[#00A693] rounded-lg hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-y-3 md:px-6"><span class="me-2">Map Interaktif</span><i class="fa-regular fa-map"></i></a>
          </li>
        </ul>
      </div>
    </div>
